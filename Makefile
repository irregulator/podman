...
binaries: podman quadlet # podman-remote rootlessport quadlet ## Build podman, podman-remote and rootlessport binaries quadlet
endif
...
install: install.bin install.systemd  ## Install binaries to system locations
